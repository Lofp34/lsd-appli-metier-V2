...
const ConventionForm: React.FC<ConventionFormProps> = ({
  ...
  const handleGeneratePdfDocument = () => {
    if (!data.client_nom || !data.formation_intitule) {
      alert("Veuillez renseigner au moins le nom du client et l'intitulé de la formation avant de générer la convention.");
      return;
    }
  ...
  const handleGenerateInvoice = async () => {
    if (!data.client_nom || !data.formation_intitule || !data.formation_tarif_ht) {
        alert("Veuillez vérifier que le nom du client, l'intitulé de la formation et le tarif HT sont renseignés avant de générer la facture.");
        return;
    }
    ...
    try {
        ...
        if (error instanceof Error) {
            ...
            setInvoiceGenerationError("Une erreur inconnue est survenue lors de la génération de la facture.");
        }
    } finally {
  ...
  return (
    <div className="bg-white p-6 rounded-lg shadow-md mt-8">
      ...
      <div className="mt-8 pt-6 border-t border-gray-200">
        ...
        >
          <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5 mr-2" viewBox="0 0 20 20" fill="currentColor">
            <path fillRule="evenodd" d="M4 4a2 2 0 012-2h8a2 2 0 012 2v12a1 1 0 01-1 1h-2.586l-2.707-2.707a1 1 0 00-.707-.293H7a1 1 0 01-1-1V4zm2 0v9h4.586l2.707 2.707a.997.997 0 00.707.293H15V4H6z" clipRule="evenodd" />
      ...
      <div className="mt-8 pt-6 border-t border-gray-200">
        <h2 className="text-xl font-semibold text-gray-700 mb-4">3. Proposition Commerciale Assistée par IA</h2>
        <button
        ...
        {isGeneratingProposal && <div className="mt-4"><LoadingSpinner /></div>}
        {proposalError && (
          <div className="mt-4 bg-red-100 border-l-4 border-red-500 text-red-700 p-4 rounded-md shadow-md" role="alert">
      ...
      {commercialProposal && !isGeneratingProposal && (
        <div className="mt-8 pt-6 border-t border-gray-200">
          ...
          {isGeneratingInvoice && <div className="mt-4"><LoadingSpinner /></div>}
