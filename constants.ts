...
export const CONVENTION_FORM_FIELDS: FormFieldConfig[] = [
  { key: 'numero_convention', label: 'Numéro de Convention', placeholder: 'SLS-YYYY-MM-DD-XXX', type: 'text' },
  { key: 'client_nom', label: 'Nom du Client', placeholder: 'Nom de l\'entreprise cliente', type: 'text' },
  { key: 'client_adresse', label: 'Adresse du Client', placeholder: 'Adresse complète du client', type: 'textarea', rows: 2 },
  { key: 'client_representant', label: 'Représentant du Client', placeholder: 'Nom du représentant', type: 'text' },
  { key: 'client_fonction', label: 'Fonction du Représentant', placeholder: 'Fonction du représentant', type: 'text' },
  { key: 'formation_intitule', label: 'Intitulé de la Formation', placeholder: 'Ex: Bootcamp Commercial Minifel', type: 'textarea', rows: 2 },
  { key: 'formation_duree', label: 'Durée de la Formation', placeholder: 'Ex: 1h par personne / X jours', type: 'text' },
  { key: 'formation_dates', label: 'Dates de Formation', placeholder: 'Ex: Semaine du 16 Septembre', type: 'text' },
  { key: 'formation_lieu', label: 'Lieu de la Formation', placeholder: 'Ex: Locaux Minifel / Distanciel', type: 'text' },
  { key: 'participants', label: 'Participants', placeholder: 'Ex: 4 commerciaux, 1 apprentie. Noms...', type: 'textarea', rows: 3 },
